        ...
        <div className={`drawer ${isOpen ? "drawer-open" : ""}`}>
            ...
            <div className="drawer-side">
                ...
                <ul className="menu bg-base-300 min-h-full lg:w-60 border-r-1 border-r-gray-300 p-0 pt-4">
                    ...
                    <li>
                        <button onClick={() => navigate("/dashboard")} className="gap-4 btn btn-ghost btn-primary justify-start text-start text-[14px] py-6 rounded-lg mx-2 lg:mx-4 hover:text-[##e0e7ff]">
                    ...
                    <li>
                        <button onClick={() => navigate("/categories")} className="gap-4 btn btn-ghost btn-primary justify-start text-start text-[14px] py-6 rounded-lg mx-2 lg:mx-4 hover:text-[##e0e7ff]">
